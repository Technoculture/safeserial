...
| SafeSerial | REQ-ARQ-RETRY-004 | DataBridgeTest.RetriesWhenAckMissing | verify_reliability.py | RC-ARQ-003 | docs/traceability/artifacts/latest/verify_reliability_report.md |
| SafeSerial | REQ-ARQ-RETRY-004 | DataBridgeTest.SendSingleFragmentAcked | verify_reliability.py | RC-ARQ-003 | docs/traceability/artifacts/latest/verify_reliability_report.md |
...
| SafeSerial | REQ-ERROR-010 | Python Retry Test | verify_reliability.py | RC-ARQ-003 | docs/traceability/artifacts/latest/verify_reliability_report.md |
